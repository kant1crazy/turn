...
def generate_listing_text(article: ArticleInfo) -> ListingText:
    ...
    prompt = (
        ...
        "- description : 2 à 4 lignes maximum. Commence par les infos clés "
        "(marque, type, taille, matière, état), puis une ligne qui donne "
        "envie (coupe, détail qui vend). Pas de remplissage, pas d'emoji "
        "excessif, pas de hashtags.\n"
